...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_interactive__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/interactive */ \"./modules/interactive.js\");\n/* harmony import */ var _modules_app_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/app.js */ \"./modules/app.js\");\n\n\n\n\nclass Task {\n  constructor(taskArray) {\n    this.taskArray = taskArray;\n  }\n\n  render = () => {\n    (0,_modules_app_js__WEBPACK_IMPORTED_MODULE_2__.renderTasks)(this.taskArray);\n    (0,_modules_app_js__WEBPACK_IMPORTED_MODULE_2__.addTask)(this.addtask, this.taskArray);\n    (0,_modules_app_js__WEBPACK_IMPORTED_MODULE_2__.editTask)(this.taskArray, this.addtask);\n    (0,_modules_interactive__WEBPACK_IMPORTED_MODULE_1__.clearByCompleted)(this.taskArray, this.addtask);\n  };\n\n  addtask = (data) => {\n    if (data) {\n      this.taskArray.push(data);\n      localStorage.setItem('taskArray', JSON.stringify(this.taskArray));\n    } else {\n      localStorage.setItem('taskArray', JSON.stringify(this.taskArray));\n    }\n  };\n}\n\nconst task = new Task(JSON.parse(localStorage.getItem('taskArray')) || []);\ntask.render();\ntask.addtask();\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
